"""
Created on Fri Jan 14 15:22:54 2022
...
class History_in_space():
     def year_2008(self):
         print("\n", "Events related to space which happened in 2008", "\n")
     ...
     def year_2011(self):
         print("\n", "Events related to space which happened in 2011", "\n")


class History_in_medicine():
     def year_2008(self):
         print("\n", "Events related to Medical Science which happened in 2008", "\n")
...
class History_in_sports():
     def year_2008(self):
         print("\n", "Events related to Sports which happened in 2011", "\n")
